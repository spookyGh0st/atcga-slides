...
manim_flags := --fps 60 --resolution 1920,1080

PHONY createp02: createp02_0 createp02_1 createp02_2
createp02_0:
	sleep 0; manim ${manim_flags} p02.py p02_0
createp02_1:
	sleep 1; manim ${manim_flags} p02.py p02_1
createp02_2:
	sleep 2; manim ${manim_flags} p02.py p02_2

PHONY createp03: createp03_0 createp03_1 createp03_2 createp03_3
createp03_0:
	sleep 3; manim ${manim_flags} p03.py p03_0
createp03_1:
	sleep 4; manim ${manim_flags} p03.py p03_1
createp03_2:
	sleep 5; manim ${manim_flags} p03.py p03_2
createp03_3:
	sleep 6; manim ${manim_flags} p03.py p03_3
...
combinep02:
	sleep 2; manim-slides convert p02_0 p02_1 p02_2 p02.html --use-template revealjs_template.html -ccontrols=true -ccontrols_layout=edges -cslide_number=true
combinep03:
	sleep 3; manim-slides convert p03_0 p03_1 p03_2 p03_3 p03.html --use-template revealjs_template.html -ccontrols=true -ccontrols_layout=edges -cslide_number=true
